...
- **Pattern-Based Sorting:** Automatically populate custom Proxy Groups (e.g., _Streaming_, _Gaming_, _Social Media_) based on regex or keyword matching from provider subscriptions.
